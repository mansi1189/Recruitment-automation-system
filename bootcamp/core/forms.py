...
class ProfileForm(forms.ModelForm):
    ...
    dob      = forms.DateField(
        widget=forms.TextInput(attrs={'class': 'form-control'}),
        required=False)
    ten    = forms.IntegerField(
        widget=forms.TextInput(attrs={'class': 'form-control'}),
        required=False)
    tenpy    = forms.IntegerField(
        widget=forms.TextInput(attrs={'class': 'form-control'}),
        required=False)
    twelve    = forms.IntegerField(
        widget=forms.TextInput(attrs={'class': 'form-control'}),
        required=False)
    twelvepy    = forms.IntegerField(
        widget=forms.TextInput(attrs={'class': 'form-control'}),
        required=False)
    ...
    branch    = forms.CharField(
        widget=forms.TextInput(attrs={'class': 'form-control'}),
        required=False)
    live_kt    = forms.IntegerField(
        widget=forms.TextInput(attrs={'class': 'form-control'}),
        required=False)
    dead_kt    = forms.IntegerField(
        widget=forms.TextInput(attrs={'class': 'form-control'}),
        required=False)
